      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        <div class="col">
          <div class="card shadow-sm">
           <img class="bd-placeholder-img card-img-top" src="zlocin_i_kazna_feniks.jpg" width="100%" min-height="225px" role="img"><title>Placeholder</title>
            ...
            <div class="card-body bg-white" style="height: 300px;"s>
        ...
        <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="btn-group bg-white">
                  <button id="about" type="button" class="btn btn-sm btn-outline-secondary" onclick="document.location='knjiga.php?id=5'">Detalji</button>
